    ...
    while working:
        ...
        if int(inputs) == 1:
           ...
           # -----------GOAL SCORES-----------------------------
            ...
            matchs = controller.queryMatchsbyPeriod(name_tournament, start_date, end_date ,control['model']['goalscore'], control['model']['results'])
            printSimpleTable(matchs,['date','tournament','country','city','home_team','away_team','home_score','away_score'])
            print_req_3(control)
